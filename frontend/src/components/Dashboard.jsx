      ...
      <main className="container mx-auto p-6">
        ...
        {chatrooms.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-green-800 bg-gray-900 p-12 text-center">
            <p className="mb-4 text-xl text-gray-400">You haven't created any chatrooms yet</p>
            <button onClick={handleCreateChatroom} className="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors flex items-center">
              <svg className="mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
              </svg>
              ...
              >
                <div className="p-6 pb-2">
                  <div className="flex items-center justify-between">
                    <h3 className="text-xl text-green-500 font-semibold">{chatroom.name}</h3>
                  ...
                  <p className="text-blue-400 text-sm">Created on {formatDate(chatroom.createdAt)}</p>
                </div>
                <div className="px-6">
